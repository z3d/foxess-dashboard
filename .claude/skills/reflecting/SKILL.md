...
Read the current state first — `README.md`, `CLAUDE.md`, `AGENTS.md`, the skills, `wrangler.jsonc`, `src/worker.js` (scan routes), and `public/index.html` (version + features) — then fix what has drifted.
...
| Environment variables | README.md, CLAUDE.md |
| iOS 12 constraints | CLAUDE.md (truth), frontend skill's reference to it |
| Version-bump rule | CLAUDE.md, frontend skill |
